...
import 'package:global_net/widgets/lessonchatdrawer.dart';
...
class _LessonChatPageState extends State<LessonChatPage> {
  ...
  _sendMessage() {
    if (messageEditingController.text.isNotEmpty) {
      ...
      DatabaseService().lessonSendMessage(widget.groupId, chatMessageMap);
  ...
  void initState() {
    super.initState();
    DatabaseService().getChatsLesson(widget.groupId).then((val) {
      setState(() {
        _chats = val;
      });
    });
